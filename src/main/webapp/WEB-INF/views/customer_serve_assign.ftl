        ...
        <table cellspacing="8px">
            <table cellspacing="8px">
                ...
                <tr>
                    <td>分配给：</td>
                    <td>
                        <input class="easyui-combobox" id="assigner" name="assigner" data-options="panelHeight:'auto',editable:false,valueField:'userName',textField:'userName',url:'${ctx}/user/find_customer_manager'"/>&nbsp;<font color="red">*</font>
                    </td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>分配时间：</td>
                    <td>
                        <input type="text" id="assignTime" readonly="readonly"/>
                    </td>
                </tr>
            </table>
    </form>
